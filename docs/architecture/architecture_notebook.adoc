...
Die dritte Ebene des C4-Modells beschreibt Komponente, aus welchen die Container bestehen. Außerdem wird in diesem Diagramm die Beziehung zwischen einzelnen Komponenten aufgeführt.
