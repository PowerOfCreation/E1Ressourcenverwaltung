...
Die logische Sicht wird durch ein C4 Modell dargestellt. Das C4-Modell ermöglicht es uns die verschiedene Elemente und ihre Beziehungen darzustellen, damit kann die Architektur unseres Programmes in verschieden Detailgraden dargestellt werden. 
