...
Model-View-Controller ist ein Architekturmuster, das einen flexiblen Softwareentwurf ermöglicht. Das Muster besteht aus drei Komponenten:

- *Model:* Verwaltung der Datenstruktur der Anwendung.

- *View:* Darstellung von Daten in der Benutzeroberfläche.

- *Controller:* Steuerung von Model und View.

Der Vorteil vom MVC ist, dass alle drei Komponenten voneinander getrennt sind. Das bedeutet, dass Änderungen von einer Komponente vorgenommen werden können, ohne dass die anderen zwei Komponenten negativ beeinflusst werden.
...
- Benutzer interagiert mit dem Softwaresystem "Ressourcenverwaltung"
