...
* Der Browser unterstützt HTML5-fähigen Browser und Javascript ist aktiviert.
...
* Status: Enthält alle Informationen zu den Stati, zum Beispiel welche Projekte ein User an einem Tag hat.

* Projekt: Enthält konkrete Informationen zu den Projekten, zum Beispiel Name, Benutzer und eine Farbe. Für Urlaub/Krankheit wird jeweils ein Projekt angelegt, um dies auch als Status realisiere zu können.
