...
Die dritte Ebene des C4-Modells beschreibt Komponente, aus welchen die Container bestehen. Im folgenden Diagramm sind alle API-Komponenten aufgeführt


Außerdem wird in diesem Diagramm die Beziehung zwischen einzelnen Komponenten aufgeführt.

Im Diagramm sind alle API 
