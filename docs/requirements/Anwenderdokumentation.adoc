...
Ebenfalls erfolderlich sind folgende Angaben:
Vorname, Nachname, Abteilung, Email Adresse und ein Passwort.
...
In der Projekt Verwaltung können Projekte erstellt oder gelöscht werden.

Bei Erstellung eines neuen Projektes werden folgende Daten benötigt:
Projektname, Verantwortlicher, Thema.
...
Wurde das Projekt erfolgreich angelegt, erscheint eine Bestätigung im oberen Rand.

image::ProjektErstellenErfolgreich.jpg[]

Soll ein Projekt gelöscht werden, wählt man diesen in der Übersicht aus.
