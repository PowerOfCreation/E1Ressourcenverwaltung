...
|Benutzerkonto |Zusammensetzung von Benutzername, Vorname, Nachname und Passwort.|String|Emailadresse muss @-Zeichen und Punkt enthalten. Passwort muss min. 8 Zeichen lang sein und min. ein Sonderzeichen besitzen. |Login
|xx|xx|xx|xx|xx|
|===
