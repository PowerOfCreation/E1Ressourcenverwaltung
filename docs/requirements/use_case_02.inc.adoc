...
. Der Use Case beginnt, wenn Benutzer auf den Knopf "Mitarbeiter hinzufügen" klickt
...
. Benutzer erstellt einen neuen Benutzer durch Klicken auf "Mitarbeiter Hinzufügen"
...
Wenn Benutzer im Schritt 1 des Standardablauf auf den Knopf "Mitarbeiter hinzufügen" gedrückt hat, dann 
...
. *Sc1:* Benutzer A klickt in der Wochenansicht auf den Button "Mitarbeiter hinzufügen". Er wählt B66 Benutzernamen für den Benutzer Max Mustermann. Er wird der Abteilung "Marketing" zugeordnet. Als E-Mail gibt er Max@t-systems.de ein. Er vergibt ein Passwort unter Beachtung der Mindestanforderungen. Danach klickt er auf "Benutzer erstellen".
