...
|eine erfolgreiche Lösung wäre |kalendarische Darstellung der Projekte, Aufgaben und Verfügbarkeiten der Mitarbeiter sowie beifügen wichtiger Informationen
|===
...
|Geschäftsleiter |Person/-en mit der Führung der Geschäfte betraut sind | Verantwortungs- & Entscheidungsträger der Gesellschaft. Besonderes Interesse an effizientem Arbeiten und übersichtlicher Informationen über die Tätigkeiten der Mitarbeiter sowie dem Fortschritt der Projekte
...
//die Frage bezieht sich eher auf die Nutzer bei der Telekom als auf uns -> 1 Woche 
...
//evtl Kalender und Benutzerkonto tauschen, da Kalender wichtiger?
[%header, cols="4,1,4,1"]
|===
...
//Nutzung ist eigentlich mehr Datensicherheit
