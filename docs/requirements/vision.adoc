...
Dieses Visions-Dokument bezieht sich auf das Ressourcenverwaltungssystems, das von E1_Ressourcenverwaltung entwickelt wird. Das System wird es T-Systems Multimedia Solutions GmbH erlauben, personelle Ressourcen besser zu verwalten und das Zeitmanagement zu erleichtern. Damit können allgemein Zeit und Aufwand eingespart sowie suboptimale Belegungnen besser erkannt werden.
...
|eine erfolgreiche Lösung wäre |kalenadrische Darstellung der Projekte, Aufgaben und Verfügbarkeiten der Mitarbeiter sowie beifügen wichtiger Informationen
|===
...
| Gesetzgeber | verbindliche Vorgabe von allgemeingültigen Rahmenbedingungen | Datenschutzrichtlinien
...
. Anzahl der Personen, die an der Erfüllung der Aufgabe beteiligt sind. Ändert sich das?   
   ...
   * Ab Februar sind wir noch 7, da Helena Rubein unser Team verlässt.
...
|Projektverwaltung|hoch| Erstellung neuer Projekte, Zuweisung von Mitarbeitern und Verfügbarkeiten| xx
