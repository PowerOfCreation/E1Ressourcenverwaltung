...
Dieses Visions-Dokument bezieht sich auf das Ressourcenverwaltungssystems, das von E1_Ressourcenverwaltung entwickelt wird. Das System wird es T-Systems Multimedia Solutions GmbH erlauben, personelle Ressourcen besser zu verwalten und das Zeitmanagement zu erleichtern. Damit können allgemein Zeit und Aufwand eingespart sowie suboptimale Belegungen besser erkannt werden.
...
|Benutzerkonto|hoch| Erstellen, bearbeiten und löschen von Benutzerkonten und Passwörter | xx 
