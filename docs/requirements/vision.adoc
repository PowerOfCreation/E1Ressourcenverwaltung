...
|Im Gegensatz zur	| aktuellen Situation, da zu diesem Zweck kein System vorhanden. Die Projekte/Aufgaben werden im Meeting zugeteilt
|===
...
. Welche anderen Anwendungen sind im Einsatz? Muss ihre Anwendung mit diesen integriert werden?
   ...
   * nur Importierung der Feiertage per API und händisch   
