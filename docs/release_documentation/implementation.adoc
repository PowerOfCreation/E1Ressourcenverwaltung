...
* Projektverwaltung: Neues Projekt anlegen Erfolgsmeldung #83 -> nicht begonnen und dann von Niklas in nächster Iteration beendet. Musste beendet werden, da vom TS im Gespräch gefordert
...
Die Test- und Betriebsdokumentation sind fast fertig und haben bloß noch Kleinigkeiten, die korrigiert werden sollen.
