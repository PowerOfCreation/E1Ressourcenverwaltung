...
Eine Funktion zum Anzeigen des Passworts wurde implementiert. Die Überprüfung des Passwortes und der E-Mail Adresse im Back-End fehlt weiterhin. (#33 & #36)
...
Es zeichnete sich ab, dass neben dem Fernbleiben einiger Teammitglieder, auch andere bisher eine nur geringe Beteiligung vorweisen konnten. Dieser Umstand wurde im Teammeeting thematisiert und um Besserung gebeten, aber aufgrund fehlender Dringlichkeit (wie wir zu dem Zeitpunkt dachten) wurde von weiteren Maßnahmen abgesehen. 

Zu Beginn des neuen Semesters wurde relativ schnell deutlich, dass die Arbeitsmoral der einzelnen Teammitglieder weit auseinander gehen sollte. Das wurde besonders durch die Zeitplanungstabelle deutlich. Leider beeinflusste dies auch die Moral der anderen Mitglieder und auch den wöchentlichen Arbeitsfortschritt. 
Weiter stellte Herr Prof. Anke das Angebot, dass sich jedes Team sofern gewünscht Verstärkung holen kann.

Für uns lag, angesichts der beschriebenen Entwicklung, nahe dieses Angebot anzunehmen.

== Iteration 12 (12.04.2022 - 25.04.2022)

In dieser Iteration haben wir mit Herrn Nguyen, welcher bereits Erfahrung in der Front-End und Back-End Entwicklung mitbringt, die erbetene Verstärkung erhalten. Mit seinem Wissen konnte er bei der Implementierung sofort mithelfen und Herrn Werner entlasten, der bisher viel aushelfen musste bei den vergebenen Aufgaben zur Implementation. Die Teammoral wurde dadurch spürbar verbessert.
...
Diese Entscheidung wurde, einige Tage bevor Herr Nguyen unser Team verstärkt hat, getroffen.
...
Wie bereits in den anderen Iterationen beschrieben, waren manche Teammitglieder nach wie vor aus gesundheitlichen Gründen verhindert. Auf Nachfrage konnte in Erfahrung gebracht werden, dass dieser Umstand noch länger bestehen bleiben wird.
...
Aufgrund des beschriebenen Problems bezüglich des Formatierungstool bei Herrn Nguyen, wurde beschlossen das Tool nicht mehr zu verwenden und es wurde sich auf eine einheitliche Formatierung geeinigt. 
...
Bisher ist die Verbesserung hinsichtlich der Produktivität noch ausbaufähig, auch wenn sie durch Herr Nguyen gesteigert werden konnte.
//Namen
...
Herr Tichonow und Herr Beck(krank) konnten in dieser Iteration leider nichts beitragen.
...
// Die weitere Bearbeitung der Entwicklerdokumentation übergab Herr Beck, aufgrund einer Umverteilung der Aufgaben, an Herrn Kirchhoff und Herrn Tichonow.
...
analyse und entwurf hauptsächlich im 3. semester
implementierung und test hauptsächlich im 4. semester
dokumentation immer
