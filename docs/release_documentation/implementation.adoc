...
== Iteration 10 (29.03.22 - 04.04.22)
...
Neue Ziele: Dummy Status einfügen #48 -> fertig
...
Neue Ziele:  Status anzeigen #51 -> keine ahnung was da los war
...
Neue Ziele: Wechsel der Wochenansicht #66 -> erst bloß vitali und in nächster iteration hat sich vinh noch damit rein gemacht -> fertig
