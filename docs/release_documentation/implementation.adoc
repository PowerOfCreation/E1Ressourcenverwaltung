...
Herr Keil und Frau Tartz waren immer noch krank, daher sollte Herr Kemter bei beiden Nachfragen, was Stand der Dinge ist. Frau Tartz konnte wenige Tage wieder mitarbeiten. Herr Keil war aufjeden Fall noch weitere Wochen krank. Daher teilten wir diese schlechte Neuigkeit
herrn anke mitteilen -> was da als antwort kam noch formulieren
...
Herr Werner hat den Vorschlag gebracht, dass wir Pull-Request verwenden sollten. Dies würde unsere Qualitätssicherung verbessern und Verbesserung an den Commits könnten besser kommuniziert werden. Wir verliesen uns hier auf seine Erfahrung, da er in dem Bereich bereits eine Ausbildung hatte und uns seine Gründe sinnvoll erschienen. 
//stimmt das mit der ausbildung? :D

Die probierte Iterationszeit von zwei Wochen hat uns in dieser Iteration nicht überzeugt. Daher haben wir wie vorher besprochen die Zeit wieder auf eine Woche herabgesetzt. 

//ist das eine entscheidung oder eher problem?
=== Problem
Wir hatten weder die Erfahrung noch die Zeit unseren Code mit Unit-Tests zu testen, da wir zu dem Zeitpunkt trotz unseren Fortschritts noch zu wenig Funktionen realisiert haben.
Da wir natürlichen wissen, dass Testen wichtig ist, hat Frau Tartz manuelle Test durchgeführt. Außerdem wurde auf erneuten Rat von Herrn Werner statische Codeanalysen für PHP und JavaScript eingeführt. Diese analysieren unseren Code auf unbenutzte Variabeln und Codestücke, außerdem auf unsichere Funktionen
//stimmt das so?
...
Er forderte, dass nach der Erstellung des Mitarbeiters und eines Projektes eine Bestätigung der Aktivität angezeigt wird und die Seite wieder zurück auf die Kalenderansicht wechselt. Außerdem merkte er an, dass das Design noch zu wünschen übrig lies. Diese Anmerkungen setzten wir als Issues für die kommenden Iteration an.

=== Implementation

Die geforderten Designverbesserungen wurden von Herrn Kemter begonnen und wurden über die nächsten Iterationen fortgeführt. Das Ziel war eine bessere Darstellung der Inhalte. Zuvor waren diese z.T. hochkant dargestellt, was nicht besonders Gut aussah. Außerdem sollte die Lesbarkeit verbessert und dem Benutzer ein Verbessertes Feedback gegeben werden, was anklickbar ist. 
...
=== Entscheidung
Herr Keil war immer noch Krank. Daher haben wir entschieden diesen Sachverhalt nochmal an Herrn Prof. Anke zu schreiben und ihm mitzuteilen, das wir gegen eine benotung von Herrn Keil sind. Wir begründeten diese Entscheidung damit, dass er keine Chance mehr hatte einen angemessenen Arbeitsanteil zu leisten. Von Herrn Prof. Anke erfuhren wir, dass sich Herr Keil bereits in der woche zuvor selbstständig abgemeldet hatte.
