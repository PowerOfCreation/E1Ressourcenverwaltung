...
*UC 3*
Eine Funktion zum Anzeigen des Passworts wurde implementiert (#36). Die Überprüfung des Passwortes und der E-Mail Adresse im Back-End fehlt weiterhin. (#33)
...
*UC 3*
Die Überprüfung des Passwortes und der E-Mail Adresse im Back-End fehlt weiterhin. Es wurden Verbesserung an der bestehenden Front-End Überprüfung vorgenommen, indem neue required Attribute und Placeholder eingefügt wurden (#33 & #36). 
...
Herr Kemter und Herr Beck verbesserten die bereits geschrieben Texte im Projektbericht. Herr Kemter verfasste außerdem neue Textpassagen.
...
Herr Beck und Herr Kemter erweiterten und verbesserten den Projektbericht weitherin. Da Beide sich nicht in der Lage fühlten die Implementation zu beschreiben übernahm Herr Werner diesen Teil.
...
Einige Dokumentationen haben noch Kleinigkeiten zum Verbessern und zum Hinzufügen, dazu gehört Beispielsweise die Softwaredokumentation in der Entwicklerdoku. 

Weiterhin wurde durch Herrn Werner und Herrn Nguyen die Implementation im Projektbericht ergänzt. Herr Kemter und Herr Beck haben sich um den Rest des Projektberichts gekümmert. Dazu haben sie sich auch mit Herrn Zirkelbach getroffen um einige Sachverhalte nachzufragen. Diesen entsprechend wird weitergearbeitet. Frau Tartz bearbeitete das "Way of Working".
...
Die einzelnen Elemente, z.B. das Sequenzdiagramm, der Entwicklerdokumentation wurde von Herr Kirchhoff und Herr Tichonow zu einem Dokument zusammengefügt.

Das Glossar wurde von Herr Werner auf den neusten Stand gebracht.

Der Projektbericht wurde an weniger Stellen noch einmal verbessert, beispielsweise wurden Links zu GitHub gesetzt. Außerdem wurden alle Dokumente einer Rechtschreib und Grammatikkontrolle unterzogen.
