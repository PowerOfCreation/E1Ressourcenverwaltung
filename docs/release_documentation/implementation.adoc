...
Leider konnten die Passwortkriterien-Aufgabe immer noch nicht abgeschlossen. 


== Problem

Es wurden kaum neue Aufgaben vergeben, zeitgleich gab es aber auch kaum alte zum fortführen. Hier wurde das 1. Mal gemerkt, dass das Projekt zu stocken beginnt. Jedoch gab es noch die Hoffnung, dass die besser wird.
...
Dieses Mal konnten die Dummy-Daten einfeführt werden 
...
Da der Beleg aktuell war, musste bloß unser neues Mitglied Vinh Nguyen in die Dokumentation eingetragen und grob eingeführt werden
...
Außerdem wollten wir uns mit Herrn Zirkelbach treffen und ein paar kleine Sachen (z.B. aus dem korrigierten Beleg) zu fragen und unseren Fortschritt mit der Anwendung zu zeigen. außerdem krankheit

Herr Keil's Aufgabe wurde nicht mehr vergeben, da die Kräfte mehr gebündelt werden mussten um an anderen Stellen mit wichtigeren Funktionen Fortschritt zu erzielen. 
