...
Wöchentlich wird der Stand des Projektes in den Teammeetings abgeglichen. Dadurch kann sich ein Überblick über die beendeten Aufgaben und deren Bewertung verschafft werden. Die Iterationslänge wurde am Anfang des Projekts auf eine Woche festgelegt.
...
|I10
| 
* Verbesserung des Beleges weiterführen, insbesondere Architecture Notebook und Projekt Plan.
...
|I15
|
* Am 18.5 wird sich mit Herrn Liebert getroffen, der Projektfortschritt präsentiert und neues Feedback eingeholt. Die Erkenntnisse werden zum nächsten Teammeeting besprochen.
...
|17.05.2022-23.5.2022
|-

|I16
|
* Herr Kemter verbessert das Design der Webanwendung.
* Frau Tartz und Herr Kemter beginnen die Abgabedokumentation.
* Die geforderten Veränderungen des Themenstellers sollen eingearbeitet werden, wie Erfolgsmeldung und Rückkehren auf andere Seite nach Erstellen eines Projekts/Mitarbeiter.
* Einige Kleinigkeiten, wie Psalm oder den Status PK in der DB zu ersetzen, sollen erledigt werden.
* Weiterhin wird die Webanwendung durch bereits begonnene Funktionen erweitert. 
|24.05.2022-30.05.2022
|-

|I17
|
* Die Abgabedokumentation wird weiterhin erstellt.
* Herr Kirchhoff erarbeitet eine Lizenz für unser Projekt.
* Inhaltlich beendete Pull Requests, sollen geschlossen und mit Main gemerged werden.
* Weiterhin wird die Webanwendung durch bereits begonnene Funktionen erweitert. 
...
|I18
|
* Es werden die Test-, Entwickler- und Benutzerdokumentation angefangen.
* Der Projektbericht wird weitergeführt.
* Das Design wird noch einmal überarbeitet, anhand der Internetseite der Telekom selbst.
* Es sollen mindestens folgende Funktionen erstellt werden: Benachichtigungen, wenn ein Mitarbeiter bzw. ein Projekt erstellt wurden ist. Außerdem soll das Login realisiert werden. Wenn Zeit übrig ist, dann kann das Löschen von Mitarbeitern und Projekten, sowie Stati aus dem Kalender, ebenfalls realisiert werden.
