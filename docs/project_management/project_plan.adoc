...
Zu Anfang jeder Iteration werden Aufgaben an die einzelnen Teammitglieder vergeben, welche bis zur nächsten Iteration im angemessenem Maße bearbeitet werden sollen. Die Aufgaben sind normalerweiße kleine Teilfunktionen der Webanwendung.
