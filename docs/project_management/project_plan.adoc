...
Zu Anfang jeder Iteration (7-tägig) werden Aufgaben an die einzelnen Teammitglieder vergeben, welche bis zur nächsten Iteration im angemessenen Maße bearbeitet werden sollen. Die Aufgaben sind kleine Teilfunktionen der Webanwendung. 
...
Es ist geplant, dass vorallem Herr Werner, Herr Kemter und Frau Tartz die Test planen und ausführen.
...
|I15
|
* Am 18.5 wird sich mit Herrn Liebert getroffen und der Projektfortschritt wird besprochen. Die Erkenntnisse werden zum nächsten Teammeeting besprochen
* Herr Kemter wird das Design der Webanwendung ansprechender gestalten
* Die Funktionen der Webanwendung werden erweitert. Das Wechseln der Wochen soll fertig gestellt werden.
|17.05.22-23.5.22
|-
|=== 
