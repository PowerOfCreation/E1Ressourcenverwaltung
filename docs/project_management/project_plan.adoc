...
//"whole team"
// -> jeder kann nach hilfe fragen bzw die meinung zu den teammeetings
...
* Dadurch wird fehlerhafte bzw. unklaren Dokumentation, die später eventuell zu Fehlern führen könnte, minimiert
