...
//erfüllt unsere Methode diese Praktik oder tun wir dies erst zu einem späterem Zeitpunkt?
- Concurrent Testing 

Concurrent Testing wird bei uns im Team angewendet. Jedoch noch nicht mit fest geschriebenen Vorgaben, welche Eingaben welche Ausgaben erwarten, oder Programmen. Stattdessen Testet jedes Teammitglied frei, ob es die erwarteten Ergebnisse eintreten oder nicht.   
