...
Zu Anfang jeder Iteration (7-tägig) werden Aufgaben an die einzelnen Teammitglieder vergeben, welche bis zur nächsten Iteration im angemessenen Maße bearbeitet werden sollen. Die Aufgaben sind normalerweise kleine Teilfunktionen der Webanwendung. 
//funktionszuwachs??
...
|I14
|
* Frau Tartz testet die Webanwendung. Dazu wird Sie verschiedene Falscheingaben etc. tätigem
