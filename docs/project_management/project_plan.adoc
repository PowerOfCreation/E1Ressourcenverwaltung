...
Zu Anfang jeder Iteration (7-tägig) werden Aufgaben an die einzelnen Teammitglieder vergeben, welche bis zur nächsten Iteration im angemessenen Maße bearbeitet werden sollen. Die Aufgaben sind kleine Teilfunktionen der Webanwendung. Jedoch wird in einer Iteration auch der Iterationsplan erstellt und weitere Dokumente aktualisiert.
