...
Carl Kirchhoff; Aleksandra Tartz; Vitali Tichonow
...
| Mockup erstellen [#1] | 1 | x | x |  | 2 | Nick, Alexandra | x | x

|use cases weiter ausarbeiten | 2 | x | x | x | 2 | Vitali, Jonas | x | x

|Risikoanalyse erarbeiten  | 2 | x | x | x | 2 | Carl, Niklas | x | x

|Vision fortführen   | 2 | x | x | x | 2 | Justus | x | x
|===
